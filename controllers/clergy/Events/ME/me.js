const Events = require('../../../../models/clergy/Events/me')
...
const CreateLadiesEvents = async(req,res)=>{
    ...
    try{
        ...
        return res.status(StatusCodes.OK).json({msg:'Mens Events was created', ladiesEvents})
...
const GetAllEventsLadies = async(req,res)=>{
    ...
    try{
        ...
        if(!AllladiesEvents){
            ...
            return res.status(StatusCodes.NOT_FOUND).json({msg:'No Mens Events were fetched'})
        }

        return res.status(StatusCodes.OK).json({msg:"The mens Events are the following:", AllladiesEvents})
...
const GetSingleLadiesEvents = async(req,res)=>{
    ...
    try{
        ...
        if(!singleladiesEvent){
            ...
            return res.status(StatusCodes.NOT_FOUND).json({msg:`Mens Event with the ID of:${eventId} has not been found`})
        }

        return res.status(StatusCodes.OK).json({msg:'The single Mens Event is:', singleladiesEvent})
...
const UpdateLadiesEvents = async(req,res)=>{
    ...
    try{
        ...
        return res.status(StatusCodes.OK).json({msg:`The mens Event with id of ${eventId} has been updated successfully:`, updateladiesEvent})
...
const DeleteLadiesEvents = async(req,res)=>{
    ...
    try{
        ...
        return res.status(StatusCodes.OK).json({msg:`Mens Event with the id of ${eventId} has been deleted successfully`})
...
const SearchLadiesEvents = async(req, res)=>{
    ...
    try{
        ...
        if(foundladiesEvents.length === 0){
            ...
            return res.status(StatusCodes.NOT_FOUND).json({msg:'The specified mens event was not found'})
        }

        return res.status(StatusCodes.OK).json({msg:'mens Event Found is:', foundladiesEvents})
