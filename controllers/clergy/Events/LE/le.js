const Events = require('../../../../models/clergy/Events/le')
...
const CreateLadiesEvents = async(req,res)=>{
    ...
    try{
        ...
        return res.status(StatusCodes.OK).json({msg:'Ladies Events was created', ladiesEvents})
...
const GetAllEventsLadies = async(req,res)=>{
    ...
    try{
        ...
        if(!AllladiesEvents){
            ...
            return res.status(StatusCodes.NOT_FOUND).json({msg:'No Ladies Events were fetched'})
        }

        return res.status(StatusCodes.OK).json({msg:"The Ladies Events are the following:", AllladiesEvents})
...
const GetSingleLadiesEvents = async(req,res)=>{
    ...
    try{
        ...
        if(!singleladiesEvent){
            ...
            return res.status(StatusCodes.NOT_FOUND).json({msg:`Ladies Event with the ID of:${eventId} has not been found`})
        }

        return res.status(StatusCodes.OK).json({msg:'The single Ladies Event is:', singleladiesEvent})
...
const UpdateLadiesEvents = async(req,res)=>{
    ...
    try{
        ...
        return res.status(StatusCodes.OK).json({msg:`The Ladies Event with id of ${eventId} has been updated successfully:`, updateladiesEvent})
...
const DeleteLadiesEvents = async(req,res)=>{
    ...
    try{
        ...
        return res.status(StatusCodes.OK).json({msg:`Ladies Event with the id of ${eventId} has been deleted successfully`})
...
const SearchLadiesEvents = async(req, res)=>{
    ...
    try{
        ...
        if(foundladiesEvents.length === 0){
            ...
            return res.status(StatusCodes.NOT_FOUND).json({msg:'The specified Ladies event was not found'})
        }

        return res.status(StatusCodes.OK).json({msg:'Ladies Event Found is:', foundladiesEvents})
